...
!define PRODUCT_NAME "ChineseChessCtr"
...
Function InstallChineseChessControl
    ExecWait 'regsvr32.exe /c "$INSTDIR\bin\${PRODUCT_NAME}.ocx"' $0
    DetailPrint 'regsvr32.exe /s /c "$INSTDIR\bin\${PRODUCT_NAME}.ocx" returned $0'
    ; MessageBox MB_OK 'regsvr32.exe /s /c "$INSTDIR\bin\${PRODUCT_NAME}.ocx" returned $0'
FunctionEnd
...
Section Uninstall
  ExecWait 'regsvr32.exe /u "$INSTDIR\bin\${PRODUCT_NAME}.ocx"' $0
  ;SetShellVarContext all
